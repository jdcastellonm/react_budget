        ...
        <div className="content-container">
            <div className="input-group">
                ...
                <div className="input-group__item">
                    ...
                    onDatesChange={this.onDatesChange} focusedInput={this.state.calendarFocused} onFocusChange={this.onFocusChange}
                    numberOfMonths={1} isOutsideRange={() => false} showClearDates={true} startDateId={'startDateId'} endDateId={'endDateId'}/>
                </div>
            </div>
        </div>
        )
